...
> **URL Pública:** [https://nexus-tech-store.netlify.app](https://nexus-tech-store.netlify.app)
>
...
| Nombre | Rol |
|---|---|
| *(Integrante 1)* | Frontend / Catálogo |
| *(Integrante 2)* | Carrito / LocalStorage |
| *(Integrante 3)* | Checkout / Validaciones |
| *(Integrante 4)* | Diseño / CSS / UX |

> Completa con los nombres reales del equipo.
...
| **LocalStorage** | Web API | Persistencia de carrito, pedidos, leads, analytics |
...
### Opción A — Netlify (Drag & Drop) — Recomendado
```
1. Ve a https://netlify.com y crea una cuenta gratuita
2. En el dashboard, arrastra la carpeta del proyecto al área de deploy
3. Netlify genera una URL HTTPS automáticamente en ~30 segundos
4. Opcionalmente cambia el nombre en: Site Settings → Change site name
```

### Opción B — Netlify + GitHub (Despliegue continuo)
```
1. Sube el proyecto a un repositorio público en GitHub
2. En Netlify: Add new site → Import an existing project → GitHub
3. Selecciona el repositorio → Deploy site
4. Cada push al repositorio actualizará el sitio automáticamente
```
...
3. Guardar. La URL será: https://tu-usuario.github.io/nexus-tech-store
```

### Opción D — Vercel
```
1. Ve a https://vercel.com y conecta con GitHub
2. Import → selecciona el repositorio → Deploy
3. URL generada automáticamente con HTTPS
```
